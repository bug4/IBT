    ...
    <div style={{ 
      ...
      <div style={{ width: '100%', textAlign: 'center', margin: '32px 0 16px' }}>
        ...
        <div style={{ 
          ...
          <div style={{ color: 'black' }}>experiment by <span style={{ color: 'black', fontWeight: 'bold', textDecoration: 'underline' }}>@BonkInfinite</span></div>
        </div>
      ...
      <div style={{ 
        ...
        <div style={{ color: 'black', marginBottom: '8px' }}>
          Support development of Infinite Bonk Ideas 2: <span style={{ 
            ...
            color: '#fd9d3e', 
            padding: '4px' 
          }}>6PmNU6yQ471gsHKSy3p7uvr96UvbbKHRzG8Jm35nmYP8</span>
        </div>
